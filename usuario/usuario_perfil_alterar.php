...
<section class="principal_usuario_alterar">
            ...
            <hr>
            <form name="cadastro" method="post" action="usuario_perfil_update.php">
                ...
                <div class="btn-cadastro">
                    <a href="usuario_perfil.php"><button type="button" class="btn-cadastro-primary">Voltar</button></a>
                    <button type="submit" class="btn-cadastro-secondary">Salvar dados</button>
                </div>
